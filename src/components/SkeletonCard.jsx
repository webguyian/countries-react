const SkeletonCard = () => {
  return (
    <div
      role="status"
      className="w-[250px] border border-gray-200 shadow animate-pulse dark:border-gray-700"
    >
      <div className="flex items-center justify-center h-40 border-b bg-gray-300 dark:bg-gray-700">
        <svg
